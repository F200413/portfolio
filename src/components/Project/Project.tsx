      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>
              MakStores Website</h3>
              <p>


              An e-commerce platform built for MAKSTORE LLC, integrated with Amazon to expand reach and boost sales. I developed a responsive, user-friendly site optimized for performance and reliability. The website is tailored for retail needs and ensures seamless customer experience across devices.
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              A powerful POS solution built to streamline sales, inventory tracking, and customer data management in real time. Developed using C++ and Oracle 19c for fast processing and reliable data storage. Ideal for businesses of all sizes, offering scalability and operational efficiency.           
              
              </p> </div>
            <footer> <ul className="tech-list"> <li>C++</li> <li>Oracle 19c</li> <li>SQL</li> 
            <li>Git</li>
            <li>SQL</li>Object-Oriented Programming (OOP)
            </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              {/* Removed GitHub and external link images as requested */}
              <a >
                  <img src={githubIcon} alt="GitHub" />
                </a>
            </header>
            <div className="body">
              <h3>WebTestHub</h3>
              <p>
              WebTestHub is a cloud-based test automation platform built for speed, scalability, and efficiency. It enables automated testing of web applications with support for parallel test execution using containers. CI/CD pipeline integration ensures seamless deployment, while the platform simplifies test environment configuration. Designed to reduce manual testing efforts and boost QA productivity, it’s ideal for teams seeking rapid and reliable software delivery.              </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Docker</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>A secure, web and mobile-friendly voting platform designed to ensure transparency, confidentiality, and trust in digital elections. It features end-to-end encryption, blockchain-based vote integrity, and multi-factor authentication for secure identity verification. Voters can easily register, verify, and cast their votes with a few clicks. Real-time updates and notifications enhance transparency throughout the election process.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Blockchain</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>BugTrackX – Defect Tracking & Test Automation Dashboard (SQA Project)</h3>
              <p>
                
              BugTrackX is an end-to-end QA solution combining manual defect tracking with automated test execution insights. Built for SQA teams, it features a real-time dashboard that tracks bug reports, test coverage, and CI pipeline results. Automated test cases are integrated using Selenium and TestNG, with reports pushed into the dashboard via Jenkins. It improves collaboration between QA and dev teams by centralizing all quality metrics.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
